...
use App\Transformers\WaktuSewaTransformer;

class WaktuSewaController extends Controller

{
    //
    public function __construct()
    {
        $permissions = WaktuSewa::PERMISSIONS;
    ...
    //             ->allowedFilters(['durasi', 'start_date'])
    //             ->paginate(),
    //         new WaktuSewaTransformer()
    //     );
    // }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return $this->fractal($user->refresh(), new WaktuSewaTransformer());
    }
